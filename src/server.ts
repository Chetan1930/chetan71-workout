...
// Hydration needs one inline bootstrap script and shadcn's chart component injects
// an inline <style> tag, so script-src/style-src can't be locked down without a
// nonce plumbed through the framework. Everything else here is fully restrictive.
